...
impl SparqlEvaluator {
    ...
    /// Attaches an explicitly shared cumulative native `DISTINCT` retained-row
    /// budget. Clones and all operations of an update share it. Create a
    /// fresh budget for each independent request. It is additive to the
    ...
    /// budget. Clones and all operations of an update share it. Create a fresh
