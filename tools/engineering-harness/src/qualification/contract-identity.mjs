...
export const G17_CONTRACT_SCHEMA = "oxigraph.g1.7-qualification-contract/v7";
...
export const G17_LEGACY_V5_CONTRACT_SHA256 =
  "155c364b57412435ae1b65d7956b58fecee8c1251efeede736ead8deb6273d70";
export const G17_LEGACY_V6_CONTRACT_SHA256 =
...
function generationForSha256(contractSha256) {
  ...
  if (contractSha256 === G17_LEGACY_V5_CONTRACT_SHA256) {
    return G17_CONTRACT_GENERATION.LEGACY_V5;
  }
  if (contractSha256 === G17_LEGACY_V6_CONTRACT_SHA256) {
    return G17_CONTRACT_GENERATION.LEGACY_V6;
  }
  if (contractSha256 === G17_CURRENT_CONTRACT_SHA256) {
    return G17_CONTRACT_GENERATION.CURRENT_V7;
  }
...
export function decodeG17ContractByteIdentity(input = {}) {
  try {
    ...
    if (generation === G17_CONTRACT_GENERATION.CURRENT_V7) {
...
export function decodeReviewedG17V5Contract({
  ...
  return decodeReviewedContract({
    contractBytes,
    contractSha256,
    expectedSha256: G17_LEGACY_V5_CONTRACT_SHA256,
    expectedSchema: "oxigraph.g1.7-qualification-contract/v5",
    label: "v5",
  });
}

export function decodeReviewedG17V6Contract({
  contractBytes,
  contractSha256,
} = {}) {
  return decodeReviewedContract({
    contractBytes,
    contractSha256,
    expectedSha256: G17_LEGACY_V6_CONTRACT_SHA256,
    expectedSchema: "oxigraph.g1.7-qualification-contract/v6",
    label: "v6",
  });
}

export function decodeReviewedG17V7Contract({
  contractBytes,
  contractSha256,
} = {}) {
  return decodeReviewedContract({
