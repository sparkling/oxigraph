...
97%. Commits `78b2cf99` through `65fb0e7a` freeze schema-v1 compatibility and
...
active nine-task/33-command v1 surface. Its focused matrices pass 87/87 on
Node 24 and 55/55 on Node 20.0.0 and 20.20.2; the top-level non-G1.7 suite
passes 694/694 on Node 24 and Node 20.20.2. The exact-admission task is 97%; the
separate ADR-0035 native task is 75% in progress. This remains dormant and
...
v7/replay, and dormant v2 command/CLI/package dispatch remain open. Until all
...
receipt v7 and dormant command/CLI/package dispatch remain open. ADR-0039
...
| `HARNESS-CREATE-EXACT` Exact new-file admission       | [ADR-0017 controls](../adr/0017-repository-evolution-and-evidence-promotion-harness.md); G2.1 product checkpoint       |    M | Proposed at 97%: early gate `fd9e4d05`, exact chain `c9cb6423`/`997ad287`/`dfd6d92d`, and separate dormant-v2 profile/contract/context/reconstruction `f9ab7c72` are implemented. Active v1 remains nine tasks/33 commands; focused evidence passes 87/87 on Node 24 and 55/55 on Node 20.0.0/20.20.2, with non-G1.7 694/694 on Node 24/20.20.2. Receipt-v7/replay, dormant command/CLI/package dispatch, host qualification, and G2.2 remain open with no product or promotion authority |
...
| Exact new-file admission / G2.2 gate       | `task-1787935934614-ibmjn1`                                                                                                                                                       | In progress at 97% through early gate `fd9e4d05`, frozen chain `c9cb6423`/`997ad287`/`dfd6d92d`, and separate dormant-v2 registration `f9ab7c72`. Focused tests pass 87/87 on Node 24 and 55/55 on Node 20.0.0/20.20.2; top-level non-G1.7 passes 694/694 on Node 24/20.20.2. Active v1 remains nine tasks/33 commands. ADR-0034 still owns receipt-v7 and dormant command/CLI/package dispatch; ADR-0039 owns qualification/activation/runtime closure. Filesystem-backed guardian/recovery, race-free exec plus pidfd/waitid evidence, complete gates, a commit-capable successor, and G2.2 stay open; no product or promotion authority |
...
`task-1787935934614-ibmjn1` was read back through Ruflo's native task API at 97%
