...
| G2.1-G2.3c metadata/receipts/outbox                          | [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                                                                                                  | G2.1 namespaces, G2.2 capture/integration, and G2.3a native atomic receipts are implemented; G2.3b-c outbox and retention remain outstanding, so ADR-0020 remains Proposed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
