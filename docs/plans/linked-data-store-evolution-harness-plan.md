...
90%. Commits `78b2cf99` through `65fb0e7a` freeze schema-v1 compatibility and
...
three independent reviews are GO for this dormant slice. This foundation is
explicitly declarative, dormant, and non-authoritative. The native guardian,
...
| `HARNESS-CREATE-EXACT` / G2.2 new-module admission           | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed, 90%: `88b9d7e7` adds the unregistered successor FD-map v2, exact launch capsule, and authority-null interactive control reducer; 237/237 related non-G1.7 controls pass on current Node and Node 20. The guardian/native mechanics, runtime closure, receipt v7/replay, evaluator/profile/CLI, complete gate, and G2.2 remain open; schema v1 remains sole gate |
...
| Exact new-file admission / G2.2 gate       | `task-1787935934614-ibmjn1`                                                                                                                         | In progress at 90%: `88b9d7e7` adds the unregistered successor FD-map v2, exact launch capsule, and authority-null interactive control reducer; 237/237 related non-G1.7 controls pass on current Node and Node 20. The guardian/native mechanics, runtime closure, receipt v7/replay, evaluator/profile/CLI, complete gate, and G2.2 stay open; no product or promotion authority |
...
`task-1787935934614-ibmjn1` was updated through Ruflo's native task API to 90%
after commit `88b9d7e7` and remains in progress. The exact capsule/control
