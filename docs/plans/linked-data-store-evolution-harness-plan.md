...
| ADR-0036 guardian static closure           | `task-1788114064268-vaigzl` / `task-1788114067364-wayobg`                                                                                           | B1 and B2 complete in `d971bfa4` and `86320201`: 92/330 semantic negatives are frozen; `protectedAliases`, `indirectCalls`, `reflectComputed`, and `bindingMemberWrites` are closed. Exact pins, mutation probes, import purity, and Node 24.14.1/20.0.0/20.20.2 matrices were independently reviewed. The candidate source remains absent, 238 semantic negatives remain, and the checkpoint grants no runtime, G1.7, qualification, promotion, or publication authority.                                                                                                                                                                                                                     |
