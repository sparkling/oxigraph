...
| `HARNESS-CREATE-EXACT` / G2.2 new-module admission           | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed, 91%: `7191ddde` adds the unregistered launch/bootstrap successor with exact exec-outcome proof, in-band capsule transfer, and cancel-only terminal replay; 248/248 related non-G1.7 controls pass on current Node and Node 20. The guardian/native mechanics, live FD0-3 and writer/cleanup proof, runtime closure, receipt v7/replay, evaluator/profile/CLI, complete gate, and G2.2 remain open; schema v1 remains sole gate |
