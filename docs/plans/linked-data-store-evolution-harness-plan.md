...
- Status: R1 delivered at source handoff `aa7128bb`; G2.2 capture/integration is
  implemented; G2.3a durable receipts is the next active product slice.
...
request/keyed integration; G2.3a task `task-1787670631130-9jlo3h` is next.
...
G2.2 is implemented, while ADR-0020 remains Proposed for G2.3a-c durable
receipts, authoritative outbox, retention, and governance health. Task
`task-1787670631130-9jlo3h` owns the next atomic-receipt slice.
...
| G2.1-G2.3c metadata/receipts/outbox                          | [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                                                                                                  | G2.1 implemented in `be08cf3b`; G2.2 capture/integration is implemented; G2.3a-c remain outstanding, so ADR-0020 remains Proposed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
