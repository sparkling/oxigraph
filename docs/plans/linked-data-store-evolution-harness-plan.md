...
86%. Commits `78b2cf99` through `65fb0e7a` freeze schema-v1 compatibility and
...
retention for the eight-file ESM/launcher payload; the expanded matrix passes
177/177. Production cgroup containment and the full path-executed runtime-
...
| `HARNESS-CREATE-EXACT` / G2.2 new-module admission           | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed and 86% in progress; unregistered partial payload-binding commit `f3a0c127` is reviewed and 177/177 related non-G1.7 controls pass, while production cgroup/full runtime-closure proof, receipt v7/replay, evaluator reconstruction, registry/CLI, and the complete gate remain mandatory before G2.2 may admit a new module           |
...
| Exact new-file admission / G2.2 gate       | `task-1787935934614-ibmjn1`                                                                                                                         | In progress at 86%: commit `f3a0c127` closes the Proposed, unregistered eight-file retained-FD payload slice after 177/177 related non-G1.7 controls; production cgroup/full runtime-closure proof, receipt v7/replay, evaluator/profile/CLI registration, the complete gate, and G2.2 remain open, with no product progress or promotion authority         |
...
`task-1787935934614-ibmjn1` was updated through Ruflo's native task API to 86%
after commit `f3a0c127` and remains in progress; its exact checkpoint is stored
