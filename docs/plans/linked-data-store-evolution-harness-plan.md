...
ADR-0037 delivery is frozen as an evaluator-first task graph, but remains held
behind complete ADR-0036. S0 (`task-1788205371168-e6caq3`) freezes the ADR-only
contract. S1 (`task-1788205386056-qz0anv`) and S3
...
| ADR-0037 evaluator-first delivery DAG      | `task-1788205371168-e6caq3` / `task-1788205386056-qz0anv` / `task-1788399091085-u7a5lw` / `task-1788205431734-trylt5` / `task-1788399095038-1zb8po` / `task-1788399098734-v8ve9g` / `task-1788399104822-pzsod1` / `task-1788399108388-65439n` / `task-1788399112386-qn8psc` / `task-1788399842562-kjszvk` | Planned and held on complete ADR-0036. The graph separates each source-absent evaluator RED from its GREEN source slice, makes S5 verification-only, permits the S1/S2 and S3 branches plus the later S4 and S6 branches to run in parallel where dependencies allow, and joins them only in S7. Corrected downstream ADR-0038 S0 is `task-1788399847418-arzwjy`; superseded untouched 0% rows remain cancelled history. Receipt: `task-plans/adr-0037-evaluator-first-dag-v2-2026-09-03`. No implementation, readiness, qualification, promotion, publication, or authority is claimed.                                                                                                                                                                                                                                                                                                                                                                        |
...
its held delivery DAG. Earlier task prose used pre-C15 10/15/25
