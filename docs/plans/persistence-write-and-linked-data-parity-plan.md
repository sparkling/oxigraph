...
| P1.1-P1.2 namespaces, effects, receipts, outbox | [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                                                                                                  | G2.1 namespaces, G2.2 native staged/request/keyed capture, and G2.3a native atomic receipts implemented; G2.3b-c outbox/retention remain outstanding, so ADR-0020 remains Proposed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
