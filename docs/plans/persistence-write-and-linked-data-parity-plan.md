...
The Ruflo record is 91% in progress. Native guardian and supervisor mechanics,
the full runtime-closure proof, receipt v7/replay,
...
| Architectural decision coverage | 10/10 | ADR-0019 is implemented; ADR-0020 has an implemented G2.1 slice but remains Proposed with ADR-0018 and ADR-0021 through ADR-0035 for their open work |
...
ADR-0018 and ADR-0020 through ADR-0035 remain Proposed for their outstanding
