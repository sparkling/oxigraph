...
with three independent GO reviews for this dormant scope. The native guardian
and supervisor mechanics, full runtime-closure proof, receipt v7/replay,
...
| P1.2 exact new-module harness admission         | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed, 90%: `88b9d7e7` adds the dormant successor FD-map v2, exact launch capsule, and authority-null interactive reducer; 237/237 pass on current Node and Node 20. The guardian/native mechanics, runtime closure, receipt v7, evaluator/profile/CLI, complete gate, and G2.2 remain open                                                                                                                                                                                                                                                                                                                                                                              |
