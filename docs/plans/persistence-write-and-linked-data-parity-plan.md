...
advances its Ruflo record to 87% by freezing the dormant candidate-specific
cgroup-v2/pidfd lifecycle contract; the related matrix passes 201/201 and the
Node 20 floor passes 34/34. That test-mechanics foundation is simulated and
non-authoritative. The sealed physical native adapter, full runtime-closure
...
| P1.2 exact new-module harness admission         | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed and 87% in progress after dormant lifecycle-contract commit `c2cdde16`; its simulated, non-authoritative mechanics pass 201/201 related non-G1.7 controls and a 34/34 Node 20 floor, while the sealed physical native adapter, full runtime-closure proof, receipt v7/replay, evaluator/profile/CLI registration, and the complete gate remain mandatory before G2.2 may admit a new semantic-change module                                                                                                                                                                                                                                                        |
...
`task-1787871483413-ki34q2` is in progress at 73%; supporting workspace/build
task `task-1787902127894-7n7vk3` is at 92%, and containment task
`task-1787902138074-0w648x` is at 89%.
