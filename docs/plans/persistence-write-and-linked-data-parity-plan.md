...
| G1.7 private build issuer and physical owners   | [ADR-0041](../adr/0041-g17-private-co-located-build-issuer.md)                                                                                                                                                                  | Proposed; S0, S1 `task-1788403485637-t9wn40`, pure S2 `task-1788403489170-xl71j9`, and Graph-V5 S3A evaluator `task-1788638011523-4c24e5` are complete and authority-null. Current umbrella `task-1788638159292-7hkaf5` is in progress; dormant source S3B `task-1788638033847-mlvsbe` is next. Host integration remains split into an ADR-0039/ADR-0040-dependent evaluator amendment and separately authorized validation, with explicit human Phase A/Phase B controls                                                                                                                                                                                                                   |
...
`a5f2442f`; S3B `task-1788638033847-mlvsbe` is the next authority-null source
step. S4A `task-1788638038970-05pyb8` separately waits for exact ADR-0039 and
