...
the schema-v2 exact new-file gate in ADR-0034. Commit `11e72201` advances its
Ruflo record to 85% with the opaque structural verifier lifecycle, but
production cgroup/retained-FD closure proof, receipt v7/replay,
...
| P1.2 exact new-module harness admission         | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed and 85% in progress after unregistered structural verifier commit `11e72201`; production cgroup/retained-FD closure proof, receipt v7/replay, evaluator/profile/CLI registration, and the complete gate remain mandatory before G2.2 may admit a new semantic-change module                                                                                                                                                                                                                                                                                                                                                                                        |
