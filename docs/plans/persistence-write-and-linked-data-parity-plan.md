...
| P1.2 exact new-module harness admission         | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed, 91%: `7191ddde` adds the dormant exact launch/bootstrap successor with in-band capsule transfer and cancel-only replay; 248/248 pass on current Node and Node 20. The guardian/native mechanics, live FD0-3 and writer/cleanup proof, runtime closure, receipt v7, evaluator/profile/CLI, complete gate, and G2.2 remain open                                                                                                                                                                                                                                                                                                                                     |
