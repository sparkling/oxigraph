...
the schema-v2 exact new-file gate in ADR-0034. Commit `f3a0c127` advances its
Ruflo record to 86% with exact retained-FD binding for the eight-file
ESM/launcher payload, but production cgroup/full runtime-closure proof, receipt
v7/replay, evaluator/profile/CLI registration, and the complete gate remain
open. The harness gate is not G2.2 product progress, and ADR-0020 remains
Proposed.
...
| P1.2 exact new-module harness admission         | [ADR-0034](../adr/0034-first-class-exact-new-file-admission.md), related to [ADR-0020](../adr/0020-transactional-metadata-receipts-and-change-delivery.md)                                                                      | Proposed and 86% in progress after unregistered partial payload-binding commit `f3a0c127`; production cgroup/full runtime-closure proof, receipt v7/replay, evaluator/profile/CLI registration, and the complete gate remain mandatory before G2.2 may admit a new semantic-change module                                                                                                                                                                                                                                                                                                                                                                                   |
