...
contract v6 and its two-phase protocol are integrated and fail-closed: control
...
Darwin-free v1/v3/v4/v5 legacy replay, canonical sample framing, paired
negative/A/A estimators and seeds, the MAD boundary, and mechanical verdict
precedence are implemented. G1.7 still owns human
...
| P0.5 compatibility/performance promotion        | [ADR-0017](../adr/0017-repository-evolution-and-evidence-promotion-harness.md), [ADR-0018](../adr/0018-transaction-guarantees-and-conflict-model.md), [ADR-0019](../adr/0019-unified-egress-cancellation-and-service-claims.md) | Registry, rejection evidence, pure owner replay, exact G1.4b prerequisite binding, Darwin-free legacy replay, and the v6 two-phase/statistics protocol are implemented. Human authorization, canonical control receipt/replay, live owners, final approval, benchmark, qualification, and human promotion remain open |
...
exact contract v6 `22cec755...`. Its control authorization `285c86fd...` and
final decision set `e2884b73...` are proposed/unapproved; `run` exits 4 at
...
receipt are absent. Legacy v1/v3/v4/v5 replay is Darwin-free and
`LEGACY_REPLAY_ONLY`.
...
`d57eb7cb...`/`5a4f5721...`. Contract v6 preserves the ordered two human
