...
The pure lifetime module exports exact frozen schemas, bounds, vocabularies,
authority/nonclaim/physical-fact values, its requirements value and canonical
SHA-256, plus these functions:
