...
The index contains 41 decisions. ADR-0018 and ADR-0020 through ADR-0041 are
...
repository ADR dry-run parses 244 unique
graph edges: 56 `depends-on`, 182 `related`, and 6 `amends`, with no duplicate,
dangling, or self edge and no directed dependency or supersession cycle.
Exact native Ruflo MCP readback matches it at 41 `adr-patterns` and 244
`adr-edges`, including all nine ADR-0041 edges.
